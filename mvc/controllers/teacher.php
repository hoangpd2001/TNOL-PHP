...
class Teacher extends Controller
{
    ...
    public function getAllFaculty()
    {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            $makhoa = $_POST['makhoa'];
            $data = $this->GiaoVienModel->getAllTeacherFaculty($makhoa);
    ...
    public function add()
    {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $makhoa = $_POST['makhoa'];
            $result = $this->GiaoVienModel->create($id, $email, $hoten, $password, $ngaysinh, $gioitinh, $nhomquyen, $trangthai,$makhoa);
            echo $result;
        }
    }
    ...
    {
        $data = $this->GiaoVienModel->getAll();
        echo json_encode($data);
    }
