...
class Subject extends Controller
{
    ...
    public function add()
    {
        ...
        $makhoa = $_POST['makhoa'];
        $result = $this->monHocModel->create($mamon, $tenmon, $sotinchi, $sotietlythuyet, $sotietthuchanh,$makhoa);
        echo $result;
    }
    ...
    public function update()
    {
        ...
        $sotietthuchanh = $_POST['sotietthuchanh'];
        $makhoa = $_POST['makhoa'];
        $result = $this->monHocModel->update($id, $mamon, $tenmon, $sotinchi, $sotietlythuyet, $sotietthuchanh, $makhoa);
        echo $result;
    }
