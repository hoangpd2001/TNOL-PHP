            ...
            <div class="block block-transparent bg-white mb-0 block-rounded">
                ...
                <div class="block-content tab-content">
                    <form novalidate="novalidate" onsubmit="return false;" class="tab-pane active form-add-user"
                        ...
                        <div class="mb-4">
                            <label for="user_khoahoc" class="form-label">Khóa học</label>
                            <select class="js-select2 form-select data-khoahoc" data-tab="1" id="user_khoahoc"
                                name="user_khoahoc" style="width: 100%;" data-placeholder="Choose one..">
                            </select>
                        </div>
                        <div class="mb-4">
                            <label for="user_nganh" class="form-label">Ngành Học</label>
                            <select class="js-select2 form-select data-nganh" data-tab="1" id="user_nganh"
                                name="user_nganh" style="width: 100%;" data-placeholder="Choose one..">
                            </select>
                        </div>
                        <div class="mb-4">
                            <label for="user_lop" class="form-label">Lớp Học</label>
                            <select class="js-select2 form-select data-lop" data-tab="1" id="user_lop"
                                name="user_lop" style="width: 100%;" data-placeholder="Choose one..">
                            </select>
                        </div>
                    ...
                    <div class="tab-pane" id="btabs-static-profile" role="tabpanel"
                        ...
                        <form id="form-upload" method="POST" enctype="multipart/form-data">
                            <div class="mb-4">
                                <label for="user_lopexcel" class="form-label">Lớp Học</label>
                                <select class="js-select2 form-select data-lop" data-tab="1" id="user_lopexcel"
                                    name="user_lopexcel" style="width: 100%;" data-placeholder="Choose one..">
                                </select>
                            </div>
                            <div class="mb-4">
                                <label for="user_password" class="form-label">Mật khẩu</label>
                            ...
                            <div class="mb-4">
                                ...
                                <input class="form-control" type="file" name="fileToUpload" id="file-cau-hoi" accept=".xlsx, .xls, .csv" required>
                            </div>
                            <div class="mb-4">
...
<!-- Modal danh sách sinh viên add -->
<div class="modal fade" id="modal-student-excel" tabindex="-1" role="dialog" aria-labelledby="modal-student"
    aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document" style="max-width: 70%;">
        <div class=" modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-sm btn-primary" id="add-user-excel">Xác Nhận</button>
