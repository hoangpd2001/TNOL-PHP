<div class="content">
    <div class="block block-rounded">
        <div class="block-header block-header-default">
            <h3 class="block-title">Tất cả Giáo Viên</h3>
            <div class="block-options">
                <button type="button" class="btn btn-hero btn-primary me-2" data-bs-toggle="modal"
                    data-bs-target="#modal-add-user" id="btn-and" data-role="nguoidung" data-action="create">Thêm giáo viên</button>
            </div>
        </div>
            ...
            <div class="block block-transparent bg-white mb-0 block-rounded">
                ...
                <div class="block-content tab-content">
                    <form novalidate="novalidate" onsubmit="return false;" class="tab-pane active form-add-user"
                        ...
                        <div class="mb-4">
                            <label for="masinhvien" class="form-label">Mã giáo viên</label>
                        ...
                        <!-- Chỉ hiện với giáo viên -->
                        <div class="mb-4">
                            <label for="user_khoa" class="form-label">Khoa</label>
                            <select class="js-select2 form-select data-khoa" data-tab="1" id="user_khoa"
                                name="user_khoa" style="width: 100%;" data-placeholder="Choose one..">
                            </select>
                        </div>
                        <div class="mb-4">
                    ...
                    <div class="tab-pane" id="btabs-static-profile" role="tabpanel"
                        ...
                        <form id="form-upload" method="POST" enctype="multipart/form-data">
                            <div class="mb-4">
                                <label for="user_password" class="form-label">Mật khẩu</label>
                                <input type="password" class="form-control form-control-alt" name="user_password"
                                    id="ps_user_group" placeholder="Nhập mật khẩu cho giáo viên!">
                            </div>
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                <em>Vui lòng soạn giáo viên theo đúng định dạng. <a href="./public/filemau/danhsachsv.xls">Tải về file mẫu
                                        Excel</a></em>
                            </div>
