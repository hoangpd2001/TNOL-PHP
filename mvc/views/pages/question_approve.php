<div class="content" data-id="<?php echo $_SESSION["user_id"] ?>">
    <div class="block block-rounded">
        <div class="block-header block-header-default">
            <h3 class="block-title">Câu hỏi chờ duyệt </h3>
                        ...
                        <form id="form_add_question" onsubmit="return false;">
                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="col-4">
                                    ...
                                    <select class="form-select" id="question-status" name="question-status" style="width: 100%;">
                            ...
                            <div class="mb-4">
                                ...
                                <button class="btn btn-alt-primary" id="edit_question"><i
                                        class="fa fa-fw fa-plus me-1"></i> Duyệt câu hỏi</button>
                                <button class="btn btn-alt-danger" id="delete_question"><i
                                        class="fa fa-fw fa-plus me-1"></i> Không duyệt </button>
