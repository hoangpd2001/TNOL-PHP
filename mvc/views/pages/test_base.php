            ...
            <div class="col-6 flex-grow-1">
                <div class="input-group">
                    ...
                    <ul class="dropdown-menu mt-1" aria-labelledby="dropdown-filter-state">
                        <li><a class="dropdown-item filtered-by-state" href="javascript:void(0)" data-value="-1">Đề ôn luyện</a></li>
                        <li><a class="dropdown-item filtered-by-state" href="javascript:void(0)" data-value="0">Đề thi chờ duyệt</a></li>
                        <li><a class="dropdown-item filtered-by-state" href="javascript:void(0)" data-value="1">Đề thi đã duyệt</a></li>
                        <li><a class="dropdown-item filtered-by-state" href="javascript:void(0)" data-value="2">Đề thi đã ẩn</a></li>
