        ...
        <div class="content px-2">
            ...
            <div id="side-content" class="d-none d-md-block push">
                ...
                <div class="form-check form-switch mb-2">
                    ...
                    <label class="form-check-label" for="trangthai">Đề kiểm tra (bỏ chọn nếu là đề ôn luyện)</label>
                </div>
                <div class="form-check form-switch mb-2">
        ...
        <div class="content content-full">
            <form class="block block-rounded form-tao-de">
                ...
                <div class="block block-content">
                    ...
                    <div class="mb-4">
                        <label for="monhoc" class="form-label d-block ">Môn học</label>
                        <select class="js-select2 form-select" id="monhoc" name="monhoc" style="width: 100%;"
