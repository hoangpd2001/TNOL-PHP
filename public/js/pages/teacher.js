  ...
  users.forEach((user) => {
    ...
    html += `<tr>
                          ...
                          <td class="fs-sm d-flex align-items-center">
                            ...
                            <td class="text-center">${user.tenkhoa}</td>
                          <td class="text-center">${
...
mainPagePagination.option.controller = "teacher";
mainPagePagination.option.model = "GiaoVienModel";
