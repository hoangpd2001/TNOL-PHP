                    ...
                    <div class="d-md-flex justify-content-md-between align-items-md-center">
                        <div class="p-1 p-md-3">
                            <h3 class="h4 fw-bold mb-3">
                                <a href="./test/detail/${test.made}?loaigiao=${
        test.loaigiao
      }&manguongiao=${test.manguongiao}" class="text-dark link-fx">
                                    ${test.tende}
                                  </a>
                            </h3>
                           <p class="fs-sm text-muted mb-2">
                                ...
                                <strong data-bs-toggle="tooltip" data-bs-animation="true" data-bs-placement="top"
                                        title="${
                                          test.nhom
                                        }" style="cursor:pointer">
                                    ${
                                      test.loaigiao == 0
                                        ? `${test.hoten} - NH${test.namhoc} - HK${test.hocky}`
                                        : `${test.namhoc}_${test.hocky} - ${test.tenmonhoc}`
                                    }
                                </strong>
                            </p>
                            <p class="fs-sm text-muted mb-1">
                                <i class="fa fa-clock me-1"></i> Chi tiết: <span>${
                                  test.nhom
                                }</span> 
                            </p>
                            <p class="fs-sm text-muted mb-1">
                                <i class="fa fa-clock me-1"></i> Diễn ra từ <span style="color:red">${strOpenTime}</span> 
                            </p>
                        </div>
                        <div class="p-1 p-md-3">
                            ${htmlTestState}
...
mainPagePagination.option.custom.function = "getAllCreatedReview";
